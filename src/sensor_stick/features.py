...
def compute_normal_histograms(normal_cloud):
    ...
    # TODO: Concatenate and normalize the histograms
    hist_features_n = np.concatenate((x_hist[0], y_hist[0], z_hist[0])).astype(np.float64)
    norm_features_n = hist_features_n / np.sum(hist_features_n)
    
    #DON'T get confused: normal and normalize are different things. (Duh)

    # Generate random features for demo mode.  
    # Replace normed_features with your feature vector
    normed_features = norm_features_n
